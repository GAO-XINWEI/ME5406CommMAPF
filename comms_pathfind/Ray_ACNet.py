...
class ACNet:
    def __init__(self, scope, a_size, trainer,TRAINING,GRID_SIZE,GLOBAL_NET_SCOPE):
        ...
        if TRAINING:
            ...
            self.target_meangoals       = tf.placeholder(tf.float32, [None])
            ...
            self.mean_goal_loss = - tf.reduce_sum(self.target_meangoals * tf.log(tf.clip_by_value(self.mean_goal, 1e-10, 1.0)) \
